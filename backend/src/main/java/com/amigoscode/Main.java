...
public class Main {
    ...
    private void testBucketUploadAndDownload(S3Service s3Service, S3Buckets s3Buckets) {
        ...
        System.out.println("Yes!! Got Object from S3: " + new String(object));
    }

    private void createRandomCustomers(CustomerRepository customerRepository, PasswordEncoder passwordEncoder) {
        var faker = new Faker();
